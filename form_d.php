...
<p><b>Category :</b> Management Quota – Admitted Students</p>
...
$q = mysqli_query($conn,"
    ...
    WHERE a.application_status='admitted'
      AND a.admission_type IN ('Re-Admission','Transfer')
...
<div class="note">
<b>Note:</b> This report lists Management quota admitted candidates generated automatically from admission records.
</div>
